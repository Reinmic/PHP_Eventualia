...
<body>
    <div class="container">
        ...
        <form action="save.php" method="POST">
            ...
            <label>Title</label>
            <input type="text" name="title" value="<?php echo $row['nombreEvent']; ?>" required>
            <label>Date</label>
            <input type="datetime-local" name="date" value="<?php echo date('Y-m-d\TH:i:s', strtotime($row['fechaEvent'])); ?>" required>
            <label>Location</label>
            <input type="text" name="location" value="<?php echo $row['lugarEvent']; ?>" required>
